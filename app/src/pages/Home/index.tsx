...
export default function Home() {
  ...
  function goToInfoPet(petSelected: Pet) {
    ...
    navigation.navigate("InfoPet", { pet: petSelected, isLogged: true, isMyPet: petSelected?.user?.id === userId });
  }

  async function getPets(index: string) {
    const url = `/pets?page=1&limit=10000000&category=${index}&name=${term}`;
